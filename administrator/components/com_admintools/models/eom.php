 ...
 * @author nicholas
 */
class AdmintoolsModelEom extends FOFModel
{
...
ENDHTML;
	...
	public function putOnline()
	{
		...
		if($result) JFile::delete(JPATH_SITE.DIRECTORY_SEPARATOR.'.htaccess.eom');
	...
	public function getHtaccess()
	{
		...
		if(!JFile::exists($sourceFile)) $sourceFile = JPATH_SITE.DIRECTORY_SEPARATOR.'.htaccess';
