...
<form name="defaultsForm" id="defaultsForm" action="index.php" method="post" class="form form-inline well">
	...
	<input type="submit" class="btn btn-primary" value="<?php echo JText::_('ATOOLS_LBL_FIXPERMSCONFIG_SAVEDEFAULTS') ?>" />
</form>
...
<form name="adminForm" id="adminForm" action="index.php" method="post">
	...
	<input type="submit" class="btn btn-warning" value="<?php echo JText::_('ATOOLS_LBL_FIXPERMSCONFIG_SAVEAPPLYPERMS') ?>" onclick="document.forms.adminForm.task.value='saveapplyperms';" />
