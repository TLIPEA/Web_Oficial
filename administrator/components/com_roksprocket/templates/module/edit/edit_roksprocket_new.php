...
<div class="panel create-new">
    <div class="panel-wrapper">
        <h1 class="step pick-provider"><span>1</span> Pick a Content Provider</h1>
        ...
        <h1 class="step pick-layout"><span>2</span> Pick a Layout</h1>
        ...
        <?php foreach($that->container['roksprocket.layouts'] as $layout_id => $layout_info):?>
            ...
            ?>
            <li<?php echo $active ? ' class="active"' : ''?> data-sprocket-layout="<?php echo $layout_id;?>"><i class="icon layout layout_<?php echo $layout_id;?> <?php echo $layout_id;?>" style="<?php echo $style; ?>"></i> <span><?php echo $layout_info->displayname?></span></li>
        <?php endforeach; ?>
        </ul>
