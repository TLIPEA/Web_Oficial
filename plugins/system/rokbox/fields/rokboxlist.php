 ...
 * @since       11.1
 */
class JFormFieldRokBoxList extends JFormField
{
	/**
	 * The form field type.
	 *
	...
	protected function getInput()
	{
		...
		if (!self::$assets_loaded){
			...
			$doc->addStyleSheet(JURI::root(true).'/plugins/system/rokbox/fields/assets/rokboxlist/css/rokboxlist.css');
			$doc->addScript(JURI::root(true).'/plugins/system/rokbox/fields/assets/rokboxlist/js/Dropdowns.js');
	...
	public function fancyDropDown($html)
	{
		...
		$output .= '<div class="rokbox-dropdown">' . "\n";
