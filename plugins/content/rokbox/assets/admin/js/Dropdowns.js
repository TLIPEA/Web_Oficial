 ...
 */
((function(){this.Dropdowns=new Class({Implements:[Options,Events],options:{data:"rokbox"},initialize:function(a){this.selects=document.getElements(".dropdown-original select");
